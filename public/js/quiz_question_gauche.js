document.addEventListener("DOMContentLoaded", function() {
    ...
    const fillHeight = (progression / 100) * maxHeight ;

    // animer la barre
    progressRect.setAttribute("height", fillHeight);
    progressFill.setAttribute('y', 550 - fillHeight);
});
...
if (lumi) {
    lumi.addEventListener('mouseenter', () => {
        ...
        tooltip.style.left = (-120 + screenX - tooltipWidth / 2) + 'px';
        tooltip.style.top = (screenY - 110) + 'px'; //  au-dessus
