...
<?= $this->section('title') ?>Nouvel Indice<?= $this->endSection() ?>

<?= $this->section('page_title') ?>Créer un Indice<?= $this->endSection() ?>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Informations de l'Indice</h3>
                </div>

                <?= form_open(base_url('/gingembre/salle_6/indice/store')) ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input([
                            ...
                            'value'       => old('libelle'),
                            'required'    => true,
                            'placeholder' => 'Entrez le libellé de l\'indice'
                        ]) ?>
