...
<?= $this->section('title') ?>Nouveau Type<?= $this->endSection() ?>

<?= $this->section('page_title') ?>Créer un Type<?= $this->endSection() ?>
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <?= form_open(base_url('/gingembre/salle_6/type/store')) ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Le libellé doit contenir entre 3 et 30 caractères</small>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="explication" id="explication" rows="4"
                                  ...
                                  placeholder="Entrez l'explication du type" required><?= old('explication') ?></textarea>
