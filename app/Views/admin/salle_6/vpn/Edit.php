...
<?= $this->section('title') ?>Modifier VPN<?= $this->endSection() ?>

<?= $this->section('page_title') ?>Modifier le VPN #<?= esc($vpn['numero']) ?><?= $this->endSection() ?>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Détails du VPN #<?= esc($vpn['numero']) ?></h3>
                </div>

                <?= form_open(base_url('/gingembre/salle_6/vpn/update/' . $vpn['numero'])) ?>
