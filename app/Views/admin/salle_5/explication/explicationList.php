        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <?= anchor(
                                '/gingembre/salle_5/explication/create',
                            ...
                            <?php foreach ($explications as $explication): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" >
                                        <?= anchor(
                                                '/gingembre/salle_5/explication/edit/' . $explication['numero'],
                                        ...
                                        <?= form_open(
                                                '/gingembre/salle_5/explication/delete/' . $explication['numero'],
                                                ['onsubmit' => "return confirm('Êtes-vous sûr de vouloir supprimer cette explication ? Cette action supprimera aussi ses liens avec les activités.')"]
                                        )
                                        ?>
                                        <?= csrf_field() ?>
                                        <?= form_button([
