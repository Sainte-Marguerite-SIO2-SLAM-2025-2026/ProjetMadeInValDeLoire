...
<head>
    ...
    <title>Gestion des Objets d'activités - Salle 5</title>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_5/objet_activite/create') ?>" class="btn btn-success float-right">
                            <i class="fas fa-plus"></i> Nouvel objet d'activité
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste des Objets d'activité</h3>
                    </div>
                    <div class="card-body">
                        <table id="objetsTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php foreach ($objetsActivites as $objetA): ?>
                                <tr>
                                    <td><?= $objetA->numero_activite ?></td>
                                    <td><?= esc($objetA->objet_id) ?></td>
                                    ...
                                    <!--                                    </td>-->
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_5/objet_activite/edit/' . $objetA->numero_activite ."/". $objetA->objet_id) ?>"
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_5/objet_activite/delete/' . $objetA->numero_activite ."/". $objetA->objet_id) ?>"
