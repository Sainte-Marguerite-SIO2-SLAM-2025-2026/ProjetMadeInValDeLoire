...
<head>
    ...
    <title>Gestion des Activités - Admin Salle 5</title>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion des Activités (500-599)</h1>
                    </div>
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_5/activite/create') ?>" class="btn btn-success float-right">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste des Activités de la Salle 5</h3>
                    </div>
                    <div class="card-body">
                        <table id="activitesTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($activites as $activite): ?>
                                <tr>
                                    ...
                                    <td><?= $activite['explication_numero'] ?></td>
                                    <td><?= $activite['width_img'] ?></td>
                                    <td><?= $activite['height_img'] ?></td>
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_5/activite/edit/' . $activite['numero']) ?>"
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_5/activite/delete/' . $activite['numero']) ?>"
