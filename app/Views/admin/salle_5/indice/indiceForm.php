...
<head>
    ...
    <title><?= isset($indice) ? 'Modifier' : 'Ajouter' ?> un Indice - Admin Salle 5</title>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_5/indice') ?>" class="btn btn-secondary float-right">
                ...
                <div class="card">
                    <form action="<?= isset($indice) ? base_url('/gingembre/salle_5/indice/update/' . $indice['numero']) : base_url('/gingembre/salle_5/indice/store') ?>"
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?= base_url('/gingembre/salle_5/indice') ?>" class="btn btn-secondary">
