        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('/gingembre/salle_4/explication') ?>" class="nav-link active">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_4/explication/create') ?>" class="btn btn-success float-right">
                        ...
                        <table id="explicationsTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($explications as $explication): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_4/explication/edit/' . $explication['numero']) ?>"
                                           class="btn btn-sm btn-primary"
                                           title="Modifier">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_4/explication/delete/' . $explication['numero']) ?>"
