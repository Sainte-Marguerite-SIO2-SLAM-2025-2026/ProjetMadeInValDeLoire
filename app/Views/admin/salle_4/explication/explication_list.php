...
<head>
    ...
    <title>Gestion des Explications - Admin Salle 4</title>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <?= anchor('/gingembre/salle_4/explication', '<i class="nav-icon fas fa-info-circle"></i><p>Explications</p>', ['class' => 'nav-link active']) ?>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion des Explications (400-499)</h1>
                    </div>
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/explication/create', '<i class="fas fa-plus"></i> Nouvelle Explication', ['class' => 'btn btn-success float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste des Explications de la Salle 4</h3>
                    </div>
                    <div class="card-body">
                        <table id="explicationsTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($explications as $explication): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= anchor('/gingembre/salle_4/explication/edit/' . $explication['numero'], '<i class="fas fa-edit"></i>', ['class' => 'btn btn-sm btn-primary', 'title' => 'Modifier']) ?>
                                        <?= anchor('/gingembre/salle_4/explication/delete/' . $explication['numero'], '<i class="fas fa-trash"></i>', ['class' => 'btn btn-sm btn-danger', 'title' => 'Supprimer', 'onclick' => "return confirm('Êtes-vous sûr de vouloir supprimer cette explication ? Cette action supprimera aussi ses liens avec les activités.')"]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
