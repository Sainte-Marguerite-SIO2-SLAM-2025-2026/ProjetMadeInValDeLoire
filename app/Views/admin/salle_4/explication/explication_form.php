...
<head>
    ...
    <title><?= isset($explication) ? 'Modifier' : 'Ajouter' ?> une Explication - Admin Salle 4</title>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/explication', '<i class="fas fa-arrow-left"></i> Retour', ['class' => 'btn btn-secondary float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <?= form_open(isset($explication) ? '/gingembre/salle_4/explication/update/' . $explication['numero'] : '/gingembre/salle_4/explication/store') ?>
                        ...
                        <div class="card-footer">
                            ...
                            <?= anchor('/gingembre/salle_4/explication', '<i class="fas fa-times"></i> Annuler', ['class' => 'btn btn-secondary']) ?>
                        </div>
