        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_4/question/create') ?>" class="btn btn-success float-right">
                        ...
                        <table id="questionsTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($questions as $question): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_4/question/edit/' . $question['numero']) ?>"
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_4/question/delete/' . $question['numero']) ?>"
