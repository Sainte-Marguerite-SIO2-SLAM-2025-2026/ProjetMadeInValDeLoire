...
<head>
    ...
    <title>Gestion des Questions - Salle 4</title>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/question/create', '<i class="fas fa-plus"></i> Nouvelle Question', ['class' => 'btn btn-success float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste des Questions du Quiz Ransomware</h3>
                    </div>
                    <div class="card-body">
                        <table id="questionsTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($questions as $question): ?>
                                <tr>
                                    ...
                                    <td><?= esc($question['libelle']) ?></td>
                                    <td class="text-center">
                                        <?php if ($question['reponse'] == 1): ?>
                                    ...
                                    <td>
                                        <small><?= esc($question['activite_libelle']) ?></small>
                                    </td>
                                    <td>
                                        <?= anchor('/gingembre/salle_4/question/edit/' . $question['numero'], '<i class="fas fa-edit"></i>', ['class' => 'btn btn-sm btn-primary']) ?>
                                        <?= anchor('/gingembre/salle_4/question/delete/' . $question['numero'], '<i class="fas fa-trash"></i>', ['class' => 'btn btn-sm btn-danger', 'onclick' => "return confirm('Êtes-vous sûr de vouloir supprimer cette question ?')"]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
