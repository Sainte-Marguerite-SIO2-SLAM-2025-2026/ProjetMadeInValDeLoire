        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_4/indice/create') ?>" class="btn btn-success float-right">
                        ...
                        <table id="indicesTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($indices as $indice): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_4/indice/edit/' . $indice['numero']) ?>"
                                           class="btn btn-sm btn-primary"
                                           title="Modifier">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_4/indice/delete/' . $indice['numero']) ?>"
