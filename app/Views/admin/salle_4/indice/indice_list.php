...
<head>
    ...
    <title>Gestion des Indices - Admin Salle 4</title>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <?= anchor('/gingembre/salle_4/indice', '<i class="nav-icon fas fa-lightbulb"></i><p>Indices</p>', ['class' => 'nav-link active']) ?>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion des Indices (400-499)</h1>
                    </div>
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/indice/create', '<i class="fas fa-plus"></i> Nouvel Indice', ['class' => 'btn btn-success float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste des Indices de la Salle 4</h3>
                    </div>
                    <div class="card-body">
                        <table id="indicesTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($indices as $indice): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= anchor('/gingembre/salle_4/indice/edit/' . $indice['numero'], '<i class="fas fa-edit"></i>', ['class' => 'btn btn-sm btn-primary', 'title' => 'Modifier']) ?>
                                        <?= anchor('/gingembre/salle_4/indice/delete/' . $indice['numero'], '<i class="fas fa-trash"></i>', ['class' => 'btn btn-sm btn-danger', 'title' => 'Supprimer', 'onclick' => "return confirm('Êtes-vous sûr de vouloir supprimer cet indice ?')"]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
