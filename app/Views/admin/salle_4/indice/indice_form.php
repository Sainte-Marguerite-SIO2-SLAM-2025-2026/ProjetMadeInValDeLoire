    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/indice', '<i class="fas fa-arrow-left"></i> Retour', ['class' => 'btn btn-secondary float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <?= form_open(isset($indice) ? '/gingembre/salle_4/indice/update/' . $indice['numero'] : '/gingembre/salle_4/indice/store') ?>
                        ...
                        <div class="card-footer">
                            ...
                            <?= anchor('/gingembre/salle_4/indice', '<i class="fas fa-times"></i> Annuler', ['class' => 'btn btn-secondary']) ?>
                        </div>
