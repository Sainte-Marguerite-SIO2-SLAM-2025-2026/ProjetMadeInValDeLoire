        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_4/carte/create') ?>" class="btn btn-success float-right">
                        ...
                        <table id="cartesTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($cartes as $carte): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('/gingembre/salle_4/carte/edit/' . $carte['numero']) ?>"
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url('/gingembre/salle_4/carte/delete/' . $carte['numero']) ?>"
