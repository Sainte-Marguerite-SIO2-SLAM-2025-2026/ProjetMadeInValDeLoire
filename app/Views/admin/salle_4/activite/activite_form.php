    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="<?= base_url('/gingembre/salle_4/activite') ?>" class="btn btn-secondary float-right">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <form action="<?= isset($activite) ? base_url('/gingembre/salle_4/activite/update/' . $activite['numero']) : base_url('/gingembre/salle_4/activite/store') ?>"
                          method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?= base_url('/gingembre/salle_4/activite') ?>" class="btn btn-secondary">
