        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <?= anchor('/gingembre/salle_4/activite/create', '<i class="fas fa-plus"></i> Nouvelle Activité', ['class' => 'btn btn-success float-right']) ?>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <table id="activitesTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach ($activites as $activite): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= anchor('/gingembre/salle_4/activite/edit/' . $activite['numero'], '<i class="fas fa-edit"></i>', ['class' => 'btn btn-sm btn-primary']) ?>
                                        <?= anchor('/gingembre/salle_4/activite/delete/' . $activite['numero'], '<i class="fas fa-trash"></i>', ['class' => 'btn btn-sm btn-danger', 'onclick' => "return confirm('Êtes-vous sûr de vouloir supprimer cette activité ?')"]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
