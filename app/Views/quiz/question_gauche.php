...
<div class="quiz-container">
    <div class="quiz-wrapper">
        <svg
            ...
            <defs>
                ...
                <clipPath id="clip_clavier">
                    <path
                            d="m 780,747 v -27 l 92,-166 192,5 97,170 -4,18 z"
                    />
                </clipPath>
            ...
            <image
                    xlink:href="<?= base_url('images/quiz/ecran-question-70.svg') ?>"
                    x="0"
                    y="0"
                    width="1920"
                    height="1080"
                    ...
                    <div class="score-modal" onclick="event.stopPropagation()">
                        ...
                        <div class="score-content">
                            ...
                            <p class="score-message">
                                <?php if ($pourcentage >= 90) echo " Excellent ! Vous êtes un expert !";
                                elseif ($pourcentage >= 70) echo "Très bien ! Bon travail !";
                                elseif ($pourcentage >= 50) echo " Pas mal ! Continuez à vous entraîner !";
                                else echo " Ne vous découragez pas ! Réessayez !"; ?>
                            </p>
            ...
            <g id="retour" class="zone-retour" data-piece="Retour" transform="translate(135, 100)">
                <!-- Image de base -->
            ...
            <rect id="barre_progression"
                  x="1520" y="100" ry="20" rx="20"
                  width="63" height="450"
                  fill="none" stroke="url(#strokeGradient_progressBar)" stroke-width="4"
                  filter="url(#glow_progressBar)"
                  opacity="0.9"
            />
            ...
            <rect id="progressFill"
                  x="1522" y="550"
                  width="59" height="0"
                  fill="url(#progressGradient)" ry="20" rx="20"/>
            ...
            <defs>
                ...
                <!-- Gradient pour le contour de progress barre-->
                <linearGradient id="strokeGradient_progressBar" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        pointer-events:none; z-index:9999;">
            Ha ha… tu espérais de l’aide ? <br>
            Dans ce manoir, <br>
...
<script src="<?= base_url('js/quiz_question_gauche.js') ?>"></script>
